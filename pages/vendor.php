...
<img src="../image/main.png" /> <div id="logo"> 
 ...
 <ul>
  ...
  <div id="content">
    ...
    <div id="c1"><span class="txtuserreg"> <img src="../image/office.png" width="74" height="76" alt="us" />Vendor List:</span></div>
    <div id="c2"><hr/><form action="" id="form1" method="post" name="form1">
     ...
     <br/>  <table border="0" align="center" cellpadding="7" cellspacing="7">
        <tr>
          ...
          <td bgcolor="#438C47">company</td>
          <td bgcolor="#CC9">&nbsp;</td>
        </tr>
        <?php do { ?>
        <tr>
          <td><a> <?php echo $row_eqp['vendor']; ?>&nbsp; </a></td>
          <td><?php echo $row_eqp['phone']; ?>&nbsp; </td>
          <td><?php echo $row_eqp['address']; ?>&nbsp; </td>
            <td><?php echo $row_eqp['company']; ?>&nbsp; </td>
          <td><a href="vendor.php?equipid=<?php echo $row_delete['equipid']; ?>" class="kk"><img src="../image/delete.png" width="30" height="25" /></a></td>
        </tr>
