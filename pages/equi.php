...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "eqp")) {
  $insertSQL = sprintf("INSERT INTO tbl_equip (name, vendor, amount, phone, address,company, `date`) VALUES (%s, %s, %s, %s,%s,%s, %s)",
 ...
 <ul>
  ...
  <tr>
    ...
    <td width="320"  > 
      ...
      <input name="name" type="text" autofocus="autofocus" required="required" id="name" placeholder="equipment name" />
     </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> 
      <input name="price" type="text" autofocus="autofocus" required="required" id="price" placeholder="price" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> 
      <input name="address" type="text" autofocus="autofocus" required="required" id="agetxt" placeholder="address" />
          ...
          <tr>
    <td height="40" bgcolor="#669999" >Company</td>
    <td> 
      <input name="company" type="text" autofocus="autofocus" required="required" id="agetxt" placeholder="company" />
         </td>
  </tr>
...
<input type="hidden" name="MM_insert" value="eqp" />
     ...
     &nbsp; <p style="text-align: center; text-decoration-color: white"> Designed and Developed by Madhuri and Pareeshma</p>
  </div>
  </div>
